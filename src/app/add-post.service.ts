...
export class AddPostService {
  ...
  getAllPostsOfUser(userId: Number):Observable<Array<PostPayload>>{
    return this.httpClient.get<Array<PostPayload>>("http://localhost:8080/api/posts/getPosts/"+userId);
  }
